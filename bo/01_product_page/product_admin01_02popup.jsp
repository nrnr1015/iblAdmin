					...
					<div class="table_box">
						...
						<div class="tb_area">
							<table>
								...
								<tbody>
									<tr>
										<th><p><span>*</span> <em>품번코드</em></p></th>
										<td colspan="3">
									...
									<tr>
										<th><p><span>*</span> <em>브랜드명</em></p></th>
										<td>
											<input type="text" class="popup_put">
										</td>
										<th><p><em>자체상품코드</em></p></th>
										<td>
											<input type="text" class="popup_put">
										</td>
									</tr>
									<tr>
										<th><p><span>*</span><em>사업/위탁</em></p></th>
										<td colspan="3">
											<div class="filter_box">
									...
									<tr>
										...
										<td colspan="3">
											<div class="filter_box">
												...
												<button type="button" class="edit_btn">매입처관리</button>
											</div>
										</td>
									</tr>
									<tr>
										<th><p><span>*</span> <em>물류처</em></p></th>
										<td colspan="3">
											<div class="filter_box">
												<select class="select type2">
													<option value="">선택</option>
												...
												<button type="button" class="edit_btn">창고관리</button>
											</div>
										</td>
									</tr>
									<tr>
										<th><p><em>카테고리</em></p></th>
										<td colspan="3">
											<div class="filter_box">
												<select class="select type1">
													<option value="">대분류</option>
												...
												<button type="button" class="edit_btn">카테고리관리</button>
											</div>
										</td>
									</tr>
									<tr>
										...
										<td class="origin">
											...
											<input type="text" class="put_ant">
										</td>
									</tr>
									<tr>
										<th><p><em>상품상태</em></p></th>
										<td>
											<div class="filter_box">
												<select class="select type2">
													<option value="">선택</option>
									...
									<tr>
										<th><p><span>*</span> <em>판매단위</em></p></th>
										<td>
											<div class="filter_box">
												<select class="select type2">
													<option value="">선택</option>
										...
										<th>
											<p><span>*</span> <em>원가</em></p> 
											<strong>(개당 1,000,000,000원)</strong>
										</th>
										<td>
											<input type="text" class="popup_put">
										</td>
									...
									<tr>
										<th><p><span>*</span> <em>판매가</em></p></th>
										<td>
											<input type="text" class="popup_put">
										</td>
										<th><p><span>*</span> <em>TAG가</em></p></th>
										<td>
											<input type="text" class="popup_put">
										</td>
									</tr>
									<tr>
										<th><p><span>*</span> <em>배송특징</em></p></th>
										<td>
											<div class="filter_box">
												<select class="select type2">
													<option value="">선택</option>

...
<html>
	...
	<body>
			...
			<div class="container">
				<div class="content_wrap">
					<div class="oder_input">
						<h2>발주서입력 <span class="sub">(먼저 대표품목 1개를 선택하시면 입력이 편합니다.)</span> <button type="button" class="add_write" onclick="showPop01();">대표품목 선택</button></h2> 
						<div class="tb_area">
							<table>
		...
		<script>
			function showPop01() {window.open("/bo/popup/document_popup23.jsp", "a", "width=1600, height=800, left=500, top=60");}
		</script>
	</body>	
</html>
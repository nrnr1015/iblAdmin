...
<html>
	...
	<body>
                ...
                <div class="document_st">
                    <div class="window_wrap">
                        <div class="head">
                            ...
                            <div class="btn_area">
                                <button type="button" class="btn_cm change_form">수정</button>
                                <button type="button" class="btn_cm b-close">취소</button>
                            </div>
                        </div>
                        <div class="td_wrap">
        ...
        <div class="popup_cm admin change_pop"> 
            <div class="document_st">
                <div class="window_wrap wrap_squa">
                    ...
                    <div class="tb_area">
                        <input type="text" placeholder="수정할 내용을 입력해주세요.(필수)">
                    </div>

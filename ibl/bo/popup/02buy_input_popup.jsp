					...
					<div class="window_wrap wrap_squa">
						...
						<div class="content_wrap td_wrap">
							<div class="oder_input">
								<h3>(먼저 해당 발주서를 선택하시면 입력이 편합니다.) <button type="button" class="add_write">발주서 선택</button></h3> 
								<div class="tb_area">
									<table>
										...
										<table>
											...
											<tbody>
												<tr>
													...
													<th><p><em>창고존 (사업품 구매시 선택)</em></p></th>
													<td colspan="2"> 
														<div class="filter_box">
															<select class="select type4" disabled>
																<option value="">선택</option>
																<option value="">텍스트</option>
																<option value="">텍스트</option>
																<option value="">텍스트</option>

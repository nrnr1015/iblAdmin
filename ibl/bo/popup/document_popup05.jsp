	...
	<body>
                                ...
                                <div class="line_edit after">
                                    <div class="my_line">
                                        ...
                                        <div class="tabs_cont">
                                            <div id="tab_1">
                                                <div class="acco_box">
                                                    <h3 class="comp_name">(주)카카오</h3>
                                                    <ul class="first_none depth_ul"> <!-- 활성 on -->
                                                        <li class="comp_onner"> <button type="button" class="rank">대표이사</button></li>
                                                        <li>
                                                            <button type="button" class="rank">CFO</button>
                                                            <ul class="first_none depth_3">
                                                                <li><button type="button" class="on">이정재 이사</butto></li>
                                                                <li><button type="button">누구 차장</butto></li>
                                                                <li><button type="button">이정재 이사</butto></li>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <button type="button" class="rank">개발팀</button>
                                                            <ul class="first_none depth_3">
                                                                <li><button type="button">이정재 이사</butto></li>
                                                                <li><button type="button">누구 차장</butto></li>
                                                                <li><button type="button">이정재 이사</butto></li>
                                                    ...
                                                    <table class="choice_td">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td><span>[(주)카카오-마켓팅팀]</span></td>
                                                            </tr>
                                                            <tr>
                                                                <th><input type="checkbox"></th>
                                                                <td><span>[(주)카카오-마켓팅팀]</span>부장 유재석</td>
                                                            </tr>
                                                            <tr>
                                                                <th><input type="checkbox"></th>
                                                                <td><span>[(주)카카오-마켓팅팀]</span>차장 유재석</td>
                                                            </tr>
                                                            <tr>
                                                                <th><input type="checkbox"></th>
                                                                <td><span>[(주)카카오-마켓팅팀]</span>과장 유재석</td>
                                                            </tr>
                                                            <tr>
                                                                <th><input type="checkbox"></th>
                                                                <td><span>[(주)카카오-마켓팅팀]</span>대리 유재석</td>
                                                            </tr>
                                                            <tr>
                                                                <th><input type="checkbox"></th>
                                                                <td><span>[(주)카카오-마켓팅팀]</span>대리 유재석</td>
        ...
        <script>
            ...
            $(document).ready(function(){
                $(".acco_box .comp_name").click(function(){
                    $(this).next().slideToggle();
                });
                $(".acco_box .rank").click(function(){
                    $(this).next().slideToggle();
                })
            })
        </script>

	...
	<body>
                ...
                <div class="document_st">
                    <div class="window_wrap">
                        <div class="head">
                            ...
                            <div class="btn_area">
                                <button type="button" class="btn_cm report">상신취소</button>
                                <button type="button" class="btn_cm">결제라인 수정</button>
                                <button type="button" class="btn_cm">본문수정</button>
                            </div>
        ...
        <script> 
            ...
            $(document).ready(function() {
                $('.document_st .messg .info_layer').css({"display":"none"});
                $('.document_st .messg dt strong , .info_layer').hover(
                    function(){

								...
								<div class="page_area after">
									<div class="check_layer">
										...
										<div class="layer_select">
											<button type="button" class="cm_btn layer_btn">보관함</button>
											<ul class="layer"> <!-- 활성 .on -->
												<li><button>다시 확인해야 할 문서들</button></li>
												<li><button class="on">인사평가에 필요한 문서들</button></li>
												<li><button>소중한 나의 문서들</button></li>
											</ul>
										</div>
									</div>

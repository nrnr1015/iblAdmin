			...
			<div class="container">
				<div class="content_wrap">
					...
					<div class="content_gap">
						<ul class="list_style st_num04"><!-- (st_num01 하나일때) (st_num02 두개일때)~~... -->
							<li><button type="button">전체 (<span class="num">300</span>)</button></li>
							<li><button type="button">결제할문서 (<span class="num">300</span>)</button></li>
							<li><button type="button">결제예정문서 (<span class="num">300</span>)</button></li>
							<li><button type="button">결제한문서 (<span class="num">300</span>)</button></li>
						</ul>
						<div class="list_cont">
							<div class="list_read">
								<div class="page_area after">
									<div class="check_layer">
										<input type="checkbox" class="check_board">
										<button type="button" class="cm_btn">일괄결제</button>
									</div>
							...
							<div class="list_read">
								<div class="page_area after">
									<div class="check_layer">
										<input type="checkbox" class="check_board">
										<button type="button" class="cm_btn">삭제</button>
									</div>
									<button type="button" class="bg_ty refresh">새로고침</button>
									<div class="search_area">
										<input type="text" class="search_put" value="어쩌고검색">
